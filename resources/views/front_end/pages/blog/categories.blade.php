...
@section('title', 'Blog | '.$blog_category->name.' | Moh Visual')
@section('description','Moh Visual: Check Out All Blog Posts In '.$blog_category->name .' Category')
@section('keywords', 'Moh Visual Studios, Best Photographer,Posts, Pictures, Arts, Lifestyles, Weddings, Portraits,'.$blog_category->name)
@section('og_title','Blog | '.$blog_category->name.' | Moh Visual')
@section('og_url',url('/blog/category/'.$blog_category->slug))
@section('og_description','All Blog Posts In '.$blog_category->slug.' Category')

<?php
$image = \App\Post::where('category_id',$blog_category->id)->latest()->first();
?>
...
@section('content')
    ...
    <div class="wrapper light-wrapper">
        <div class="container inner pt-60">
            <h2 class="section-title mt-20 mb-60 text-center">Posts In "{{$blog_category->name}}" Category</h2>
