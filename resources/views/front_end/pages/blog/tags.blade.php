...
@section('title', 'Blog | Tag |'.$tag->name.' | Moh Visual')
@section('description','Moh Visual: Check Out All Blog Posts With '.$tag->name .' Tag')
@section('keywords', 'Moh Visual Studios, Best Photographer,Posts, Pictures, Arts, Lifestyles, Weddings, Portraits,'.$tag->name)
@section('og_title','Blog | Tag |'.$tag->name.' | Moh Visual')
@section('og_url',url('/blog/tag/'.$tag->slug))
@section('og_description','All Blog Posts With '.$tag->name .' Tag')

<?php
$image = $tag->posts()->latest()->first();
?>
...
@section('content')
    ...
    <div class="wrapper light-wrapper">
        <div class="container inner pt-60">
            <h2 class="section-title mt-20 mb-60 text-center">Posts With "{{$tag->name}}" Tag</h2>
