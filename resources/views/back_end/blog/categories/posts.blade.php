...
@section('page','category posts')
@section('title','Posts In "'.$cat_name.'" Category')

@section('breadcrumb')
    {{ Breadcrumbs::render('blog.category.resources', $category) }}
@endsection
...
@section('content')
    ...
    <div class="card">
        <h3 class="card-header">Category: "{{ucwords($cat_name)}}"</h3>
