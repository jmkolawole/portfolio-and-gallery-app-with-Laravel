                        ...
                        <div class="card-body">
                            <div class="table table-responsive">
                                        ...
                                        <th class="text-center" width="150px">
                                            ...
                                            <div id="myModal" class="modal fade" role="dialog">
                                                <div class="modal-dialog">
                                                    <form class="form-horizontal" role="form" method="POST" action="{{route('add.blog.category')}}">
                                                        {{csrf_field()}}
                                ...
                                @foreach($category as $value)
                                        ...
                                        <td>{{ $value->id }}</td>
                                        <td><a href="{{route('blog.category.resources',$value->slug)}}">{{ ucwords($value->name) }}</a></td>
                                        <td><div class="actions">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="">Name:</label>
                                                                     <b><a href="{{route('blog.category.resources',$value->slug)}}">{{$value->name}}</a></b>
                                                                </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <form class="form-horizontal" method="POST" role="form" action="{{route('edit.blog.category',$value->id)}}">
                                                                    {{csrf_field()}}
                                                                    <div class="card-body">
                                                ...
                                                @if(Auth::user()->hasRole('Admin'))
                                                <form action="{{route('delete.blog.category',$value->id)}}" method="POST" class="d-inline-block">
                                                    {{csrf_field()}}
