...
@section('page','Tag Posts')
@section('title','All Posts With "'.$tag_name.'" Tag')

@section('breadcrumb')
    {{ Breadcrumbs::render('tag.resources', $tag) }}
@endsection
...
@section('content')
    ...
    <div class="card">
        <h3 class="card-header">Tag: "{{ucwords($tag_name)}}"</h3>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <div class="center" style="text-align:center!important;align-content:center!important;">
...
@section('script')
    ...
    <script>
        ...
        $('.post-delete').click(function(){
            ...
            swal({
                title: "Are you sure?",
                text: "This post can not be retrieved after this action!",
                type: "warning",
                ...
                if (isConfirm) {
                    ...
                    swal("Cancelled", "The post still exist :", "error");
                }
            });
        });
