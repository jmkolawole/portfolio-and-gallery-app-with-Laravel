                        ...
                        <div class="card-body">
                            <div class="table table-responsive">
                                ...
                                @foreach($category as $value)
                                        ...
                                        <td>{{ $value->id }}</td>
                                        <td><a href="{{route('category.resources',$value->slug)}}">{{ ucwords($value->name) }}</a></td>
                                        <td><div class="actions">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="">Name:</label>
                                                                     <b><a href="{{route('category.resources',$value->slug)}}">{{$value->name}}</a></b>
                                                                </div>
                                                ...
                                                @if(Auth::user()->hasRole('Admin'))
                                                <form action="{{route('delete.category',$value->id)}}" method="POST" class="d-inline-block">
                                                    {{csrf_field()}}
