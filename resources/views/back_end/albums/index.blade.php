...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    <a href="{{route('create.album')}}" class="btn btn-success btn-sm" style="float: right!important;">
                                    ...
                                    <div class="content">
                                        <a href="{{route('album.show',$value->id)}}">
                                            ...
                                            <img class="content-image image img img-thumbnail"
                                                 src="{{asset('images/backend_images/albums/medium/'.$value->cover_image)}}">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item" href="{{route('album.delete',$value->id)}}"
                                               onclick="return confirm('Are you sure you want to delete this Album?' +
                                                ' Note that you cant retrieve all the pictures inside')">Delete</a>@endif
                                        </div>
                                    </div>
                                </div>
                    ...
                    <br>
                            <div class="row">
                                ...
                                <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12" style="text-align:center;padding-left: 10%!important;">
                                    <p style="margin-left: 2em!important;">{{$album->links()}}</p>
